...
@Slf4j
@Service
public class IventoryServiceImpl implements IIventoryService {
    ...
    @Autowired
    public IventoryServiceImpl(HbaseTemplate hbaseTemplate, MerchantsDao merchantsDao, IUserPassService userPassService) {
    ...
    public Response genInventoryInfo(Long userId) throws Exception {
